...
namespace SFA.DAS.DigitalCertificates.Web.UnitTests.Validators
{
    public class KnowYourUlnViewModelValidatorTests
    {
        ...
        {
            var vm = new KnowYourUlnViewModel { KnowUln = "Yes", Uln = null };
        ...
        {
            var vm = new KnowYourUlnViewModel { KnowUln = "Yes", Uln = 12345L };
        ...
        {
            var vm = new KnowYourUlnViewModel { KnowUln = "No", Uln = null };
