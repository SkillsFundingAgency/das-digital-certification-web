...
using SFA.DAS.DigitalCertificates.Web.HealthChecks;
...
namespace SFA.DAS.DigitalCertificates.Web.StartupExtensions
{
    ...
    {
        public static IServiceCollection AddDasHealthChecks(this IServiceCollection services, DigitalCertificatesWebConfiguration configWeb)
        {
            services
                .AddHealthChecks()
